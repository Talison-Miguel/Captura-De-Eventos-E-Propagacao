<h1 align="center">
 Captura-De-Eventos-E-Propagacao
</h1>
...
Captura de eventos, propagação e bubbling, usando javaScript.
...
```bash
  ❯ git clone https://github.com/Talison-Miguel/Captura-De-Eventos-E-Propagacao.git
```
